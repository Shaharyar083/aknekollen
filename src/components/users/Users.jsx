...
function Users() {
    ...
    const createData = (index, _id, userName, email, edit, del) => {
        return {
            index,
            _id,
            userName,
    ...
    useEffect(() => {
        setRows([]);
        store?.adminReducer?.users?.map((data, index) => {
            setRows((pValue) => {
                return [
                    ...pValue,
                    createData(
    ...
    return (
        <div className="container-fluid  height-auto">
            <div className="text-center space_top">
                <p className="main_heding"> Available Users</p>
            </div>
            <div
                        ...
                        <Table stickyHeader aria-label="sticky table">
                            ...
                            <TableBody>
                                ...
                                >
                                    ...
                                    <Modal.Body className="show-grid">
                                        {/* <UpdateCategory item={editItem} closeModel={closeModel} /> */}
                                    </Modal.Body>
                                    {/* <Modal.Footer>
